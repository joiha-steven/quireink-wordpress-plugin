...
| 3 | **One implementation of the seed hash.** It decides which of 80 strokes a mark gets. Two copies means two blogs drawing the same words differently | [`assets/js/seed.js`](../quire-ink-pen/assets/js/seed.js) | `check:contract` |
